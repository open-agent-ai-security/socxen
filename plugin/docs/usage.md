...
[installation](installation.md) — credentials in place and, on Claude Code, the governance gate merged.
...
`exabeam_update_case` (the rules you merged during setup). On Codex it is the tool-approval prompt Codex

...
On Codex that gate ships inside the plugin, and the connector itself asks you before any dismiss/close
— so it holds whether or not anyone is at the keyboard.
